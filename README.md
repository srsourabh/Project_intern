# Stateless Microservice for project
...
**1.** Clone the repo.
```
git clone https://github.com/twumm/stateless-microservice-project.git
```

**2.**  ```cd``` into repo. Use the same directory name(below) if you do not change it.
```
cd stateless-microservice-project
...
All logs are saved in ```project.log``` in the application's root.
